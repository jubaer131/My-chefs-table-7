...
const Banner = () => {
    return (
        ...
        <div className="hero bg-opacity-100  lg:h-[650px] mt-5 lg:mt-14 rounded-3xl " style={{ backgroundImage: 'url(banner.png)' }}>

            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-[900px] ">
                    <h1 className="max-sm:pt-8 mb-5 lg:text-5xl font-bold lg:leading-[60px]">Welcome to our exceptional cooking class experience!</h1>
                    <p className="mb-5 text-sm lg:text-[18px] lg:leading-[30px]">
